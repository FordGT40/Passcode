...
public class QRActivity extends Activity implements View.OnClickListener, SensorEventListener {
    ...
    private CheckBox iv_flash;
    private ImageView iv_album, iv_close;
    private static final String TAG = "QRActivity";
    private TextView textDialog;
    private TextView tv_title, tv_my_code;
    ...
    private void initView() {
        ...
        iv_flash = (CheckBox) findViewById(R.id.iv_flash);
...
//        iv_flash.setImageResource(options.getLightImageRes());
        ...
        tv_my_code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClassName("com.wisdom.passcode", "com.wisdom.passcode.homepage.activity.ShowCodeActivity");

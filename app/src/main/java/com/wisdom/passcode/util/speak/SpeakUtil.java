package com.wisdom.passcode.util.speak;
...
import com.wisdom.passcode.util.speak.listener.MessageListener;
...
public class SpeakUtil {
     ...
     */
    protected String appId = "19894168";

    protected String appKey = "cjGBHugoaDTdN9VqCCwAqYl1";

    protected String secretKey = "YdiNIAsAy0Oa0QwHjma0R253gXbylnIq";
...
//        }
    ...
    private void initPermission() {
        ...
        for (String perm : permissions) {
            if (PackageManager.PERMISSION_GRANTED != ContextCompat.checkSelfPermission((Activity) context, perm)) {

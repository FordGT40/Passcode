...
import kotlinx.android.synthetic.main.fragment_car_code_record.*
import okhttp3.Call
 ...
 * Use the [CarCodeRecordFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CarCodeRecordFragment : Fragment() {
    private var page = 1
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_car_code_record, container, false)
    }
...
//        Tools.showLoadingDialog(context)
        ...
        params.put("type", ConstantString.PASSCODE_RECORD_TYPE_CAR)
        val paramsList = listOf(
            "pageSize$pageSize",
            "pageNum$page",
            "type${ConstantString.PASSCODE_RECORD_TYPE_CAR}"
        ).toMutableList()

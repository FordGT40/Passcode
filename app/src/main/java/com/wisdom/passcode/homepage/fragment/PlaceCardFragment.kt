...
class PlaceCardFragment : Fragment() {
    ...
    private lateinit var adapter: PlaceCardListAdapter
    ...
    fun getCardsData(pullFlag: String) {
        ...
        params.put("type", ConstantString.PASS_CODE_TYPE_WORK)
        val paramsList = listOf(
            "pageSize$pageSize",
            "pageNum$page",
            "type${ConstantString.PASS_CODE_TYPE_WORK}"
        ).toMutableList()
